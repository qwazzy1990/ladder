...
\input{Background/EfficientEnumerationAndApplication}
\pagebreak

%%input revoiew of second paper
\input{Background/LadderLotteryRealization}

%%input review of third paper
\input{Background/OptimalReconfiguration}\par

%%input review of fourth paper.

%%\input{Background/EnumerationKBars}\par 
\input{Background/CodingLL}
\input{Background/RandomGenLL}
\input{Background/PermutationReview}
\input{Background/PermutationsKInversions}
\input{Background/SortingNetworks}
