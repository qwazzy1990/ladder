...
\begin{figure}[!htp]
 ...
 ~\resizebox{.9\textwidth}{.45\textheight}{
  ...
  \caption{$CanL\{\pi_{4}\}$ generated by the {\sc ModifiedSJT} algorithm. The algorithm inserts or removes a bar from the previous 
...
\begin{figure}[!htp]
  ...
  \caption{The forest for all ladders in $CanL\{\pi_{4}\}$ generated by the Cyclic Bar Algorithm. The leaf nodes present a possibly correct candidate ladder. 
...
$CanL\{\pi_{n}\}$. This claim will be proven below.
