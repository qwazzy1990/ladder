...
//recursive function for counting the number of ladders with a height of one given some N value
int recursiveT(int n)
{
   if(n == 0)return 0;
   if(n == 1)return 0;
...
//Formula to calculate the number of ladders with a height of one given some N value.
double formulaT(int n)
{
    double a = 1/sqrt(5);
...
//Formula to calculate the Nth fibonacci.
double formulaFib(int n)
{
    double a = 1/sqrt(5);
